...
public class File {
    public static void main(String[] args) throws IOException {
        ...
        // Parsing
        String testCaseTargetLine = in.nextLine();
        int testCaseTarget = Integer.parseInt(testCaseTargetLine);
        ...
        int userAns = solver.searchInSortedRotatedArray(testCaseNums, testCaseTarget);
