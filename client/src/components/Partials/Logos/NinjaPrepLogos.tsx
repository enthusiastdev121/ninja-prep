...
export const LightNavbarNinjaPrepLogo = (props: Props) => {
    return (
        <svg width={props.width} height={props.height} viewBox="0 0 200 57">
            <g id="Group_120" data-name="Group 120" transform="translate(-1157 -10208)">
                <text
                    id="NinjaPrep"
...
export const DarkNavbarNinjaPrepLogo = (props: Props) => {
    return (
        <svg width={props.width} height={props.height} viewBox="0 0 201 58">
            <g id="Group_119" data-name="Group 119" transform="translate(-1157 -10129)">
                <text
                    id="NinjaPrep"
