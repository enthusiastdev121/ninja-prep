        ...
        <div>
            <Dropdown className="pl-3">
                <Dropdown.Toggle as={ToggleDropdown} id="dropdown-basic">
                    <Image roundedCircle className="profile-picture" src={user.profile_picture} alt="ProfilePhoto" />
                </Dropdown.Toggle>
...
function DropdownItem({ url, DropdownIcon, cssClass = 'text-secondary', children }: DropdownItemProps) {
    return (
