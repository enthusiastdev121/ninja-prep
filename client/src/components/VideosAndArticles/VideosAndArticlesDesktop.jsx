...
import { ARTICLE_DESCRIPTION, ARTICLE_HEADER, STEP_BY_STEP, VIDEO_DESCRIPTION } from './VideosAndArticlesStringIds'
    ...
    <div className="text-center py-5 rainbow-bg">
        <Row className="mt-5 p-0 mx-auto container">
            <Col className="pr-5 pl-0 py-5 col-6">
                ...
                <h1 className="font-weight-bold pt-3 pb-2 w-75 mx-auto video-text display-5">{STEP_BY_STEP}</h1>
            ...
            <Col className="pl-5 pr-0 py-5 col-6">
                ...
                <h1 className="font-weight-bold pt-3 pb-2 w-75 mx-auto article-text display-5">{ARTICLE_HEADER}</h1>
