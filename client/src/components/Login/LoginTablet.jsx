...
import { FACEBOOK_LOGIN, GET_STARTED, GOOGLE_LOGIN, GITHUB_LOGIN, LOGIN_HEADER_TITLE } from './LoginStringIds'
    ...
    <div className="py-auto px-5">
        <Row className="py-5 px-0 mx-auto container">
            <Col className="pl-0 pr-5">
                <img className="pt-3 pr-5 w-100" src="./images/coursePreview.png" alt="Placeholder" />
