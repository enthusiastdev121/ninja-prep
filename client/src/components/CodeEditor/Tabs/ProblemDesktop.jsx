                    ...
                    <Card>
                        ...
                        <Accordion.Collapse eventKey="0">
                            <p className="p-3 text-dark">
                                Morbi id nisl vel neque bibendum imperdiet. Nulla facilisi. Pellentesque eget aliquet
                                metus. Aenean vitae dolor vitae ligula bibendum vulputate. Suspendisse quis neque
                                volutpat, ornare sem eget, tempor ex. Cras maximus porta luctus. Mauris posuere lacus
                                sed dui congue commodo.
                            </p>
                        </Accordion.Collapse>
                    </Card>
                    <Card>
...
export { default as ProblemDesktop } from './ProblemDesktop'
