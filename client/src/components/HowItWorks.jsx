	...
	render() {
		return (
			<div class="how-it-works-container">
				<div class="progress">
					<div class="progress-bar" style={{ width: this.state.width }}></div>
				</div>
				<div class="row">
					<div class="col-sm" id="step-1" onMouseOver={this.changeOnStep1}>
						<h2>Discover</h2>
						<p>
					...
					<div class="col-sm " id="step-2" onMouseOver={this.changeOnStep2}>
						<h2>Learn</h2>
						<p>
					...
					<div class="col-sm " id="step-3" onMouseOver={this.changeOnStep3}>
						<h2>Solve</h2>
						<p>
					...
					<div class="col-sm " id="step-4" onMouseOver={this.changeOnStep4}>
						<h2>Go</h2>
						<p>
