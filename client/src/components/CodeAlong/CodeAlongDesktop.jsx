...
const CodeAlongDesktop = () => (
    <div className="code-along-bg py-5 text-center">
        ...
        <h1 className="code-along-text font-weight-bold display-5 pb-2">{CODE_ALONG_EXECUTE}</h1>
        <p className="code-along-description mb-5 m-auto w-50 lead">{CODE_ALONG_DESCRIPTION}</p>
